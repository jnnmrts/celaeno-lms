	...
	<!-- start dashboard content -->
	 <div class=" container-scroller">
		...
		<div class="content-wrapper">
		    ...
		    <?php include("user_page/book_process/book_process_button.php"); ?>
		    ...
		    <!-- START SHOW PROJECT -->
	        	<div class="tab-content mb-5">
				    ...
				    <?php include("user_page/book_process/book_pending.php"); ?>
				    <!-- end Book pending Button -->

				    <!-- start Book overdue Button -->
				    <?php include("user_page/book_process/book_approved.php"); ?>
				    <!-- end Book apporved Button -->

				    <!-- start Book checkin Button -->
				    <?php include("user_page/book_process/check_in.php"); ?>
				    <!-- end Book checkin Button -->

				    <!-- start Book checkout Button -->
				    <?php include("user_page/book_process/check_out.php"); ?>
				    <!-- end Book checkout Button -->

				    <!-- start Book overdue Button -->
				    <?php include("user_page/book_process/book_overdue.php"); ?>
				    <!-- end Book apporved Button -->
