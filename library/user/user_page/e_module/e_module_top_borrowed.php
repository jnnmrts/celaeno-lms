	...
	<div class="row container">
		...
		<div class="col d-flex justify-content-center mb-2">
			<div class="d-flex shadow">
				<!-- startc e_module image -->
				<div class="bg-white">
					<a href="e_module_detail.php"> <img class="border" src="assets/book_img/e_module.jpg" height="250" width="170" style="object-fit: cover">
					</a>
				</div>
				<!-- end e_module image -->
