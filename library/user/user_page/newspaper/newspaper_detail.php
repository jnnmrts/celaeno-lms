...
<div class="container border mt-3 pt-5 pb-3 bg-white rounded shadow">
	...
	<div class="row container-fluid mb-5">
		...
		<div class="col text-center mb-5">
			<img class="border rounded shadow" src="assets/book_img/newspaper.png" height="400" width="250" style="object-fit: cover">
		</div>
		<!-- end image  -->
		...
		<div class="col ">
			...
			<span class="text-muted" style="font-size: 12px">Volume/Issue (not required)</span>
			<h5>Lorem</h5>
	...
	<div class="text-justify p-1">
		...
		<div>
			<a href="" class="btn btn-secondary"><i class="fa-solid fa-book"></i> Borrow this Newspaper </a>
		</div>
		<!-- end download button -->
