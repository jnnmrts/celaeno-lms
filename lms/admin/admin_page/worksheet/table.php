<div class="col-lg-12 mb-4">
  <div class="card">
    <div class="card-body">
      <h5 class="card-title mb-4">Worksheet</h5>
...
// END OF SEARCH FUNCTION
  ...
  document.querySelectorAll('.btn-primary').forEach(item => {
    item.addEventListener('click', event => {
      ...
      window.location.href = 'worksheet_view.php'; // Replace 'newspaper_view.php' with the actual URL of the view page
    });
  });
  ...
  document.querySelectorAll('.btn-info').forEach(item => {
    item.addEventListener('click', event => {
      ...
      window.location.href = 'worksheet_edit.php'; // Replace 'newspaper_edit.php' with the actual URL of the edit page
    });
  });
</script>
