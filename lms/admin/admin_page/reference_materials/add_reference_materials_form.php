<div class="container mt-5">
  <h3 class="page-heading mb-4">Add Reference Material</h3>
  <div class="row mb-2">
    <div class="col-lg-12">
      <div class="card">
        <div class="card-body">
          ...
          <!-- Start of Add Reference Material Form -->
          <form id="addReferenceMaterialForm">
